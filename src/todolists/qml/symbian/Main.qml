...
Window {
    ...
    /*!
      Sets the screen to appropriate mode. Modes that are supported are
        ...
        "newTask" shows the new task header
        "editTask" shows the edit task header
    */
    ...
    */
    ...
    TabBar {
        ...
        TabButton {
            ...
            onClicked: {
                window.resetStacks()
                pageStackWork.tasksPage.taskListView.forceActiveFocus()
            }
        }
        ...
        TabButton {
            ...
            onClicked: {
                window.resetStacks()
                pageStackHome.tasksPage.taskListView.forceActiveFocus()
            }
        }
        ...
        TabButton {
            ...
            onClicked: {
                window.resetStacks()
                pageStackShopping.tasksPage.taskListView.forceActiveFocus()
            }
        }
    }
    ...
    Keys.onPressed: {
        if (event.key === Qt.Key_Right) {
            ...
            if (tabGroup.currentTab === pageStackHome) {
                tabGroup.currentTab = pageStackWork
                window.resetStacks()
                pageStackWork.tasksPage.taskListView.forceActiveFocus()
            }
