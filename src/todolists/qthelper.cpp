...
/*!
  Adds an event to Harmattan events feed.
*/
void QtHelper::addEvent()
{
#ifdef Q_WS_HARMATTAN
    MEventFeed::instance()->addItem(QString("icon name"),
                                    QString("ToDo Lists Task"),
                                    QString("Body text"),
                                    QStringList(),
                                    ...
                                    false,
                                    QUrl(),
                                    QString("ToDo Lists example"),
                                    QString("ToDo Lists event feed example app"));
#endif
}
